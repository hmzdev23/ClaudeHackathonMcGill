          ...
          style={
            {
              ...
              // Sky-blue gradient — stays on-brand
              "--gradient":
                variant === "white"
                ...
                radial-gradient(circle at 60% 60%, #22D3EE 10%, transparent 20%),
        ...
        >
          <div
            className={cn(
              ...
              // Slower fade-off: 700ms ease-out
              "after:opacity-[var(--active)] after:transition-opacity after:duration-700 after:ease-out",
